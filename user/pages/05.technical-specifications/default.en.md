...
* Multi-engine & multi-timbral
* Up to 16 MIDI chains (MIDI+Synth+FXs)
* Unlimited number of audio chains
* Audio mixer with mainbus & mixbuses
* Pre and post-fader FXs
* Multitrack audio recorder & player
* MIDI recorder & player
* Advanced Audio & MIDI routing 
...
* Scale & semitone transposing
* Snapshots & ZS3 subsnapshots
* Supported ROM-pler formats: SF2, SF3, SFZ & GIG
* MIDI learning for mixer, processors & programs
* Sequence patterns & audio clips
  * patterns: live capture, humanization, swing, stutter ...
  * audio clips: auto-warping, beat-slice, easy crop ...
  * launcher integration: novation launchpad, akai APC, ... 
* Live Looping Sampler (SooperLooper)
* Sync to external MIDI clock
* Metronome, tuner, ...
* Arpeggiator, chorder, LFO, autotune, vocoder, ...
* Included Synth Engines: > 100
* Included Soundfonts: > 100
* Included Audio FXs: > 1000
* Included MIDI FXs: > 50
* Included Audio Generators: > 50
* Web Configuration tool
* Remote Control (VNC, OSC, MIDI)
* Access to plugin's native GUI (VNC)
* MIDI over Network: QMidiNet, RTP-MIDI, UMP, TouchOSC
* [MIDI controller device drivers](https://wiki.zynthian.org/index.php/Supported_plug_%26_play_MIDI_controllers)
* Experimental Audio to MIDI converter (Aubio)
* PureData & Pianoteq patches
* and much more ...
[/div]
